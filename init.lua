...
style.font = renderer.font.load("/usr/share/fonts/TTF/FiraCode-Regular.ttf", 14 * SCALE)
style.code_font = renderer.font.load("/usr/share/fonts/TTF/FiraCode-Medium.ttf", 14 * SCALE)
...
config.plugins.eofnewline = true
